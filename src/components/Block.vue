<template>
  <div id="shape">
    <div class="ft bg-success"><a href="#!">Block</a></div>
    <div class="rt bg-success"><a href="#!">1</a></div>
    <div class="bk bg-success"><a href="#!"></a></div>
    <div class="lt bg-success"><a href="#!"></a></div>
    <div class="tp bg-success"><a href="#!"></a></div>
    <div class="bm bg-success"><a href="#!"></a></div>
  </div>
</template>
